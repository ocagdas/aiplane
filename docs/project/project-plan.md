...
3. P2 evidence continuation: implement benchmark-suite, artifact-lock, launch-manifest, repeated-quality, and role-routing contracts without growing service scope.
...
10. **Benchmark and recommendation quality** - Placement foundation implemented / calibration and quality evaluation planned
