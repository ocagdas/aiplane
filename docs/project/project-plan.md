...
2. P2 continuation: implement benchmark-suite, artifact-lock, launch-manifest, repeated-quality, and role-routing contracts without growing service scope.
...
4. Release evidence follow-up: publish an eligible immutable release and retain the hosted checksum, attestation, cross-platform install, upgrade, and rollback evidence.
