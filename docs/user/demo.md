...
Use the canonical [external-trial evidence record](../project/trial-evidence/recording-guide.md#external-trial-evidence) and validate it before sharing. For each independent user, record:
