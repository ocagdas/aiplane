...
It is not a coding agent, chat UI, model marketplace, or production LLM gateway. Those tools sit above or beside it. `aiplane` focuses on the operational layer that makes self-managed model environments reproducible and connectable.
