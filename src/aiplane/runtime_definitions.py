...
from .runtime_specs import runtime_endpoint, runtime_spec
...
RUNTIME_DEFINITIONS: dict[str, dict[str, Any]] = {
    "ollama": {
        ...
        "gui_required": False,
        "protocol": runtime_spec("ollama").protocol,
    ...
    "docker_model_runner": {
        ...
        "managed_by_helper": True,
        "gui_required": False,
        "protocol": runtime_spec("docker_model_runner").protocol,
    ...
    "mlx": {
        ...
        "gui_required": False,
        "protocol": runtime_spec("mlx").protocol,
    ...
    "vllm": {
        ...
        "managed_by_helper": True,
        "gui_required": False,
        "protocol": runtime_spec("vllm").protocol,
    ...
    "llamacpp": {
        ...
        "managed_by_helper": "partial",
        "gui_required": False,
        "protocol": runtime_spec("llamacpp").protocol,
    ...
    "lmstudio": {
        ...
        "managed_by_helper": False,
        "gui_required": True,
        "protocol": runtime_spec("lmstudio").protocol,
...
PROVIDER_ENDPOINT_DEFAULTS: dict[str, dict[str, Any]] = {
    "ollama": {
        ...
        "substrate": runtime_spec("ollama").substrate,
        "runtime": "ollama",
        "protocol": runtime_spec("ollama").protocol,
        "endpoint": runtime_endpoint("ollama"),
        "enabled": True,
        "timeout_seconds": 60,
    ...
    "docker_model_runner": {
        ...
        "ownership": "self_managed",
        "access": {"kind": "same_host"},
        "substrate": runtime_spec("docker_model_runner").substrate,
        "runtime": "docker_model_runner",
        "protocol": runtime_spec("docker_model_runner").protocol,
        "endpoint": runtime_endpoint("docker_model_runner"),
        "enabled": False,
        "timeout_seconds": 60,
        "origin": "default_runtime_catalog",
    ...
    "mlx": {
        ...
        "ownership": "self_managed",
        "access": {"kind": "same_host"},
        "substrate": runtime_spec("mlx").substrate,
        "runtime": "mlx",
        "protocol": runtime_spec("mlx").protocol,
        "endpoint": runtime_endpoint("mlx"),
        "enabled": False,
        "origin": "default_runtime_catalog",
    ...
    "vllm": {
        ...
        "ownership": "self_managed",
        "access": {"kind": "same_host"},
        "substrate": runtime_spec("vllm").substrate,
        "runtime": "vllm",
        "protocol": runtime_spec("vllm").protocol,
        "endpoint": runtime_endpoint("vllm"),
        "enabled": False,
        "origin": "default_runtime_catalog",
    ...
    "lmstudio": {
        ...
        "ownership": "self_managed",
        "access": {"kind": "same_host"},
        "substrate": runtime_spec("lmstudio").substrate,
        "runtime": "lmstudio",
        "protocol": runtime_spec("lmstudio").protocol,
        "endpoint": runtime_endpoint("lmstudio"),
        "enabled": False,
        "origin": "default_runtime_catalog",
    ...
    "llamacpp": {
        ...
        "ownership": "self_managed",
        "access": {"kind": "same_host"},
        "substrate": runtime_spec("llamacpp").substrate,
        "runtime": "llamacpp",
        "protocol": runtime_spec("llamacpp").protocol,
        "endpoint": runtime_endpoint("llamacpp"),
        "enabled": False,
        "origin": "default_runtime_catalog",
